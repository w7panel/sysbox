...
# busybox
BUSYBOX_IMAGE="$TESTDATA/busybox-${arch}.tar.gz"
get "$BUSYBOX_IMAGE" \
	"https://gh-proxy.org/https://github.com/docker-library/busybox/raw/dist-${arch}/latest-1/glibc/${arch}/rootfs.tar.gz"
echo "BUSYBOX_IMAGE=$BUSYBOX_IMAGE"

# debian
DEBIAN_IMAGE="$TESTDATA/debian-${arch}.tar.gz"
get "$DEBIAN_IMAGE" \
	"https://gh-proxy.org/https://github.com/debuerreotype/docker-debian-artifacts/raw/dist-${arch}/bookworm/slim/oci/blobs/rootfs.tar.gz"
