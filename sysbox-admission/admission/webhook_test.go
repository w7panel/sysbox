...
func TestBuildMutatingWebhookConfiguration_setsExactRulesAndMatchCondition(t *testing.T) {
	...
	require.Equal(t, `has(object.spec.runtimeClassName) && (object.spec.runtimeClassName == "sysbox-runc" || object.spec.runtimeClassName == "sysbox-runc-lite")`, entry.MatchConditions[0].Expression)
}
