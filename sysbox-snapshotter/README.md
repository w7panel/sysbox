...
This project applies to the `sysbox-runc` and `sysbox-runc-lite` runtime paths. The global CRI image snapshotter remains the host default, for example `overlayfs`.
